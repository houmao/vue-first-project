<template>
    <div class="goods">
            ...
            <ul>
                <li class="menu-item" v-for="(item, index) in goods" :key="index" :class="{current: currentIndex == index}" @click="selectMenu(index, $event)">
                    <span class="text border-1px">
                        <start v-show="item.type > 0" :index="item.type"></start>{{item.name}}
                    </span>
                </li>
            </ul>
        </div>
        <div class="foods-wrapper" ref="foodsWrapper">
            <ul>
                <li v-for="(item, i) in goods" class="food-list food-list-hook" :key="i">
                    ...
                    <ul>
                        <li v-for="(food,ids) in item.foods" class="food-item border-1px" :key="ids" @click="selectFood(food)">
                            <div class="icon">
        ...
        <food :food="selectedFood" @cart-add="getFood" ref="food"></food>
    </div>
</template>
