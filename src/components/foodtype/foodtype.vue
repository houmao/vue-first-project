    ...
    <div class="food_container">
                ...
                <transition name="showlist">
                    <section v-show="sortBy == 'activity'" class="sort_detail_type filter_container">
                        ...
                        <footer class="confirm_filter">
                            ...
                            <div class="confirm_select filter_button_style" @click="confirmSelectFun">确定<span
        ...
        <section class="shop_list_container">
            <shop-list :geohash="geohash" :restaurantCategoryId="restaurant_category_id"
                       ...
                       :deliveryMode="delivery_mode" :confirmSelect="confirmStatus" :supportIds="support_ids"
                       v-if="latitude"></shop-list>
        </section>
    </div>
</template>
